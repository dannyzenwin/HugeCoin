...
const string strMessageMagic = "Huge Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    } else if (nHeight > 11 && nHeight <= 2012){
      nSubsidy = 1000 * COIN;
    } else if (nHeight > 2012 && nHeight <= 5000){
      nSubsidy = 0 * COIN;
...
//    if(nBestHeight >= 1000 && nBestHeight <= 25000){
//      nSubsidy = 1500 * COIN;
